  ...
  start() {
    return new Promise((resolve, reject) => {
      this.server = http.createServer((req, res) => {
        res.writeHead(200);
        res.end('Minimal Playwriter Serve');
      });
      ...
      this.server.listen(this.port, 'localhost', () => {
        ...
        console.log(`[minimal-serve] Extension: ws://localhost:${this.port}/extension`);
        console.log(`[minimal-serve] CDP: ws://localhost:${this.port}/cdp`);
        resolve();
      });
    });
  }
